            ...
            switch(event.body) {
					...
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/sửu.gif`)
						}, event.threadID, event.messageID);
						break;
					case "3":
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/dần.gif`)
						}, event.threadID, event.messageID); 
						break;
					case "4":
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/mão.gif`)
						}, event.threadID, event.messageID); 
						break;
					case "5":
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/thìn.gif`)
						}, event.threadID, event.messageID); 
						break;
					case "6":
					api.unsendMessage(handleReply.messageID);
					...
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/ngọ.gif`)
						}, event.threadID, event.messageID); 
						break;
					case "8":
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/mùi.gif`)
						}, event.threadID, event.messageID); 
						break;
					case "9":
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/thân.gif`)
						}, event.threadID, event.messageID); 
						break;
					case "10":
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/dậu.gif`)
						}, event.threadID, event.messageID); 
						break;
					case "11":
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/tuất.gif`)
						}, event.threadID, event.messageID); 
						break;
					case "12":
					api.unsendMessage(handleReply.messageID);
						api.sendMessage({
							...
							attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/hợi.gif`)
						}, event.threadID, event.messageID); 
						break;
					default:
...
module.exports.run = async ({ api, event, handleReply }) => {
	const fs = require("fs");
	const { threadID, messageID, senderID } = event;
	return api.sendMessage({ body: "==== 12 con giáp trong dân gian ====" +
                "\n1. Tý 🐁" +
                "\n2. Sửu 🐃" +
                "\n3. Dần 🐅" +
                "\n4. Mão 🐈" +
                ...
                "\n11. Tuất 🐕" +
                "\n12. Hợi 🐖" +
                "\n\n🌹Reply tin nhắn theo số để xem thêm về từng con giáp ❤"
            ,attachment: fs.createReadStream(__dirname + `/cache/12congiap.jpg`)}, event.threadID, (error, info) => {
